...
function MapPage() {
  ...
  useEffect(() => {
    ...
    if (selectedCountryIndex === -1) {
      ...
      setMapCenter({ lat: tempObject.countryInfo.lat, lng: tempObject.countryInfo.long })
      setMapZoom(4)
      setSelectedCountryData({
  ...
  return (
    <div className="map">
      ...
      <DataMap countriesData={apiCountriesData} dataType={dataType} center={mapCenter} zoom={mapZoom} />
    </div>
  )
}
