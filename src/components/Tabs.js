  ...
  return (
    <div className="tabs">
      <div className="tabs__container">
        ...
        <Link to="/" className="tabs__link" onClick={() => linkedClicked("dashboard")}>
          <div className={`tabs__tab ${activeTab === "dashboard" && "active"}`}>
            <DashboardSvg className="tabs__icon" />
            <h5 className="tabs__heading">Dashboard<br /><span>View</span></h5>
          </div>
        </Link>
        ...
        <Link to="/map" className="tabs__link" onClick={() => linkedClicked("map")}>
          <div className={`tabs__tab ${activeTab === "map" && "active"}`}>
            <MapSvg className="tabs__icon" />
            <h5 className="tabs__heading">World Map<br /><span>View</span></h5>
          </div>
        </Link>

        <Link to="/sidebar" className="tabs__link" onClick={() => linkedClicked("list")}>
          <div className={`tabs__tab tabs__listTab ${activeTab === "list" && "active"} `}>
            <ListSvg className="tabs__icon" />
            <h5 className="tabs__heading">Countries<br /><span>List</span></h5>
          </div>
        </Link>
      </div>
    </div>
